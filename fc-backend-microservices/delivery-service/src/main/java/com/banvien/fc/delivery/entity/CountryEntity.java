...
public class CountryEntity {
    ...
    private Boolean privateWholeSaler;

    @Basic
    @Column(name = "PrivateWholeSaler")
    public Boolean getPrivateWholeSaler() {
        return privateWholeSaler;
    }

    public void setPrivateWholeSaler(Boolean privateWholeSaler) {
        this.privateWholeSaler = privateWholeSaler;
    }
}
