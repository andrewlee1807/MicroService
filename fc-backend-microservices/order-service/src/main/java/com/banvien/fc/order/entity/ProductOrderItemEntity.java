...
public class ProductOrderItemEntity {
    ...
    private Double price;                                       //gia lay theo gia ban hoac group gia (pricingsku.saleprice || productoutletsku.saleprice)
    private Double priceDiscount;                               //gia tru cho gia khuyen mai
