...
public class NotifyTemplateEntity implements Serializable {
	...
	public NotifyTemplateEntity(Long notifyTemplateId, String code, String title, Integer status, String contentEn, String contentVi, String contentIn, String contentMa, String contentCn, String note) {
		this.notifyTemplateId = notifyTemplateId;
		this.code = code;
		this.title = title;
		this.status = status;
