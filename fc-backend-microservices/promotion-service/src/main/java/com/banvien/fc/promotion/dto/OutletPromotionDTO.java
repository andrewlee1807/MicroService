...
public class OutletPromotionDTO implements Serializable {
    ...
    private List<CustomerGroupDTO> customerGroupsOfOutlet;
    private CommonTemplateDTO commonTemplate;
    private String groupCode;

    private String contentXML;
    private Boolean status;
    private Integer limitPlayer;
    private SpecificPromotionStoringDTO specificPromotionStoring;
    private SpecificPromotionRenderingDTO specificPromotionRendering;
    ...
    public OutletPromotionDTO(Long outletPromotionId, String title, String description) {
        this.outletPromotionId = outletPromotionId;
        this.title = title;
        this.description = description;
    }

    public OutletPromotionDTO(Long outletPromotionId, String title, Timestamp startDate, Timestamp endDate, Boolean status, String description, Integer remainGift, Integer totalGift, String thumbnail, int quantityApplied) {
        this.outletPromotionId = outletPromotionId;
        this.title = title;
    ...
    public SpecificPromotionStoringDTO getSpecificPromotionStoring() {
        return specificPromotionStoring;
    }

    public void setSpecificPromotionStoring(SpecificPromotionStoringDTO specificPromotionStoring) {
        this.specificPromotionStoring = specificPromotionStoring;
    }
    ...
    public SpecificPromotionRenderingDTO getSpecificPromotionRendering() {
        return specificPromotionRendering;
    }

    public void setSpecificPromotionRendering(SpecificPromotionRenderingDTO specificPromotionRendering) {
        this.specificPromotionRendering = specificPromotionRendering;
    }
    ...
    public CommonTemplateDTO getCommonTemplate() {
        return commonTemplate;
    }

    public void setCommonTemplate(CommonTemplateDTO commonTemplate) {
    ...
    public List<CustomerGroupDTO> getCustomerGroupsOfOutlet() {
        return customerGroupsOfOutlet;
    }

    public void setCustomerGroupsOfOutlet(List<CustomerGroupDTO> customerGroupsOfOutlet) {
        this.customerGroupsOfOutlet = customerGroupsOfOutlet;
    }
    ...
    public int getQuantityApplied() {
        return quantityApplied;
    }

    public void setQuantityApplied(int quantityApplied) {
        this.quantityApplied = quantityApplied;
    }
}
