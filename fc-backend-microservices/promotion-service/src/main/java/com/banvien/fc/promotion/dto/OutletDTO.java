...
public class OutletDTO implements Serializable {
    ...
    private UserDTO shopman;
    private String image;
    private OutletWorkingTimeDTO outletWorkingTimeDTO;
    private List<OutletAssetDTO> outletAssets;
    ...
    private List<SocialChatDTO> socialChats;
    ...
    public OutletDTO(Long outletId, String name) {
        this.outletId = outletId;
        this.name = name;
    }
    ...
    public UserDTO getShopman() {
        return shopman;
    }

    public void setShopman(UserDTO shopman) {
    ...
    public OutletWorkingTimeDTO getOutletWorkingTimeDTO() {
        return outletWorkingTimeDTO;
    }

    public void setOutletWorkingTimeDTO(OutletWorkingTimeDTO outletWorkingTimeDTO) {
        this.outletWorkingTimeDTO = outletWorkingTimeDTO;
    }

    public List<OutletAssetDTO> getOutletAssets() {
        return outletAssets;
    }

    public void setOutletAssets(List<OutletAssetDTO> outletAssets) {
    ...
    public List<SocialChatDTO> getSocialChats() {
        return socialChats;
    }

    public void setSocialChats(List<SocialChatDTO> socialChats) {
