...
public class DeliveryServiceEntity {
    ...
    @Basic
    @Column(name = "mrspeedytoken")
    public String getMrSpeedyToken() {
        return mrSpeedyToken;
    }

    public void setMrSpeedyToken(String mrSpeedyToken) {
        this.mrSpeedyToken = mrSpeedyToken;
    }
}
