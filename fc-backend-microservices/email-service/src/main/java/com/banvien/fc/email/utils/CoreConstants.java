...
// Product
    ...
    public enum NOTIFY_TEMPLATE {
        ...
        PROMOTION_INVALID_BY_GIFT("PROMOTION_INVALID_BY_GIFT"),
    ...
    public enum FRAME_URL {
        FRAMEBLUE("/file/store-level/frameBlue.png"),
        FRAMEGREEN("/file/store-level/frameGreen.png"),
        FRAMEYELLOW("/file/store-level/frameYellow.png");
    ...
    public enum OUTLET_TYPE_SORT {
        ...
        private String value;
        OUTLET_TYPE_SORT(String value) { this.value = value; }
        public String getValue() {
            return value;
        }
    }
